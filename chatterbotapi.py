...
class ChatterBotFactory:
    def create(self, bot_type, arg=None):
        ...
        elif bot_type == ChatterBotType.JABBERWACKY:
            return _Cleverbot('http://jabberwacky.com', 'http://jabberwacky.com/webservicemin', 29)
        elif bot_type == ChatterBotType.PANDORABOTS:
            if arg == None:
...
class _PandorabotsSession(ChatterBotSession):
    ...
    def think_thought(self, thought):
        ...
        if that_elements_child_nodes is None or len(that_elements_child_nodes) == 0 or that_elements_child_nodes[
            0] is None:
            return ''
